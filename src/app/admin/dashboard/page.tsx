        ...
        <section className="flex-1 p-6 md:p-8 space-y-6 overflow-x-hidden">
          ...
          >
            ...
            >
              ...
              <p className="opacity-90 mt-1 text-sm md:text-base">
                Ringkasan aktivitas, monitoring member & jadwal kelas hari ini.
              </p>
            </div>
          </motion.div>
          ...
          <AnimatePresence>
            {selectedClass && (
              <ClassDetailModal
                data={selectedClass}
                coach={coaches[selectedClass.coach] || ({} as CoachType)}
          ...
          .map((cls) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl shadow-md p-6 flex flex-col gap-3 cursor-pointer border"
        ...
        <div className="border-t pt-4 mt-4">
          ...
          {(coach.specialties?.length ?? 0) > 0 && (
            <div className="text-xs text-gray-500">
              Spesialisasi: {(coach.specialties || []).join(", ")}
            </div>
          )}
        </div>
        <button
